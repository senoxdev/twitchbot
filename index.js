const fetch = require('node-fetch'),
    ...
    admins = ["798966890323771403", "906818715222425600", "662941172607483905"],
    config = {
        "907168741140357150": 1500,
        "907168742918737943": 150,
        "907168744080552007": 120,
        "907168745112346624": 60,
        "907168745888317490": 35,
        "907168748182573058": 15
    } 
...
client.on('message', async (message) => {
    ...
    if (command === "tfollow") {
        let twitchID = "907026441697361970";
...
client.login("OTA3MDI0OTg1NTgxODI2MDY4.YYhK2A.oLNciSZHJN2CQwaUljAImHZLLUs")
